    ...
    <div className="main">
      ...
      <div className="main-container">
        ...
        <div className="cards">
          ...
          <div className="card" onClick={() => onSent("Generate a Hello World program in Javascript")}>
            <p>Generate a Hello World program in Javascript</p>
